    ...
    <div className="space-y-12">
      <section>
        <div className="mb-8 border-b border-border/50 pb-6 flex items-end justify-between">
          ...
          <div className="px-3 py-1 rounded-md bg-info/5 border border-info/10 flex items-center gap-2">
             <span className="text-[10px] font-semibold text-info uppercase tracking-widest">Gemini 1.5 Pro</span>
          </div>
        </div>
        ...
        <div className="bg-secondary/40 rounded-xl border border-border p-6 mb-10 relative overflow-hidden group">
          <div className="relative z-10">
             <div className="flex items-center justify-between mb-6">
                <div>
                   <p className="text-[11px] font-semibold text-foreground/40 uppercase tracking-widest mb-1.5">Processing Credits</p>
             ...
             <p className="mt-4 text-[11px] font-semibold text-muted-foreground/60 uppercase tracking-wider">Monthly quota resets in 12 days</p>
          </div>
        </div>
          ...
          {[
            ...
            <div key={i} className="flex items-center justify-between group">
              <div className="max-w-[420px]">
                <p className="text-[14px] font-semibold text-foreground tracking-tight mb-0.5">{item.label}</p>
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
           <div className="flex items-center justify-between gap-10">
              <div className="max-w-[360px]">
                 <p className="text-[14px] font-semibold text-foreground tracking-tight mb-1">Match Threshold</p>
