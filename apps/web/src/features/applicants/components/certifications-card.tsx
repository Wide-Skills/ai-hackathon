      ...
      <div className="space-y-6">
        {certifications.map((cert, i) => (
          <div key={i} className="group flex gap-4">
            <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl border border-border/5 bg-secondary/30 text-muted-foreground/30 shadow-ethereal transition-all group-hover:scale-[1.05]">
