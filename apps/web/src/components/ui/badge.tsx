  ...
  "group/badge inline-flex items-center justify-center gap-1 overflow-hidden font-medium font-sans shadow-none transition-all",
  {
    variants: {
      variant: {
        ...
        "destructive-subtle": "border-error-bg bg-error-bg text-error-text",
        outline: "border border-line bg-transparent text-ink-muted",
        ghost: "bg-primary-alpha text-primary",
        link: "text-primary underline-offset-4 hover:underline",
        success: "border-success-bg bg-success-bg text-success-text",
        "success-subtle": "border-success-bg bg-success-bg text-success-text",
        info: "border-primary-alpha bg-primary-alpha text-primary",
        warning: "border-warning-bg bg-warning-bg text-warning-text",
        "warning-subtle": "border-warning-bg bg-warning-bg text-warning-text",
      },
      size: {
        default:
