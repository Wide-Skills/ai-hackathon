  ...
  return (
    <div className="pointer-events-none absolute top-8 right-8 hidden w-[240px] space-y-2 lg:block">
      {candidates.map((c, i) => (
        ...
        >
          <span className="min-w-[14px] text-center font-mono font-semibold text-[10px] text-muted-foreground/50">
            {i + 1}
          </span>
          <div
            className={`flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full border font-bold text-[9px] ${c.color}`}
          >
            {c.initials}
          </div>
          <p className="flex-1 font-medium text-[12px] text-foreground">
            {c.name}
          </p>
          <div className="flex flex-col items-end gap-1">
            <span className="font-display font-light text-[13px] text-foreground leading-none">
              {c.score}%
            </span>
      ...
      >
        <p className="mb-1 font-semibold text-[9px] text-muted-foreground/50 uppercase tracking-widest">
          AI Reasoning
        </p>
        <p className="text-[11px] text-muted-foreground leading-relaxed">
          "Strong Python &amp; ML background. 4 yrs relevant exp. Exceeds
          seniority threshold."
        </p>
      </motion.div>
    </div>
  ...
  <div className="pointer-events-none absolute inset-x-0 top-0 bottom-16 flex items-center justify-center opacity-70">
    ...
    >
      ...
      <circle
        ...
        cy="70"
        r="22"
        className="fill-info/10 stroke-info/30"
        strokeWidth="0.75"
      />
      <text
        x="80"
  ...
  <div className="pointer-events-none absolute inset-x-0 top-0 bottom-16 flex items-center justify-center opacity-75">
    ...
    >
      ...
      <text
        ...
        fontSize="8"
        fontWeight="500"
        className="fill-info-foreground"
        fontFamily="inherit"
      >
        Python · 5yr
      </text>
      ...
      <rect
        ...
        height="17"
        rx="4.5"
        className="fill-warning/10 stroke-warning/30"
        strokeWidth="0.5"
      />
      <text
        x="139"
...
const DashboardPreview = () => (
  <div className="pointer-events-none absolute top-6 right-6 hidden w-[290px] opacity-80 lg:block">
    <svg
      width="290"
      height="180"
      viewBox="0 0 290 180"
