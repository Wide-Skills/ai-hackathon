    ...
    <header className="sticky top-0 z-30 flex h-[72px] items-center justify-between border-b border-border/50 bg-background/60 px-8 backdrop-blur-md">
      ...
      <div className="flex items-center gap-6">
        <div className="relative hidden md:block w-72">
          <InputGroup className="h-10 rounded-pill border-border/50 bg-foreground/[0.02] focus-within:ring-info/20 px-1 overflow-hidden shadow-ethereal flex items-center">
            <InputGroupAddon align="inline-start" className="pl-4 flex items-center justify-center">
              <Search className="h-3.5 w-3.5 text-muted-foreground/40" />
            </InputGroupAddon>
            <InputGroupInput
              placeholder="Search talent pool..."
              className="text-[13px] font-medium border-none focus-visible:ring-0"
            />
          </InputGroup>
        </div>

        <button className="relative flex h-10 w-10 items-center justify-center rounded-pill border border-border/50 bg-background transition-all hover:bg-secondary active:scale-[0.95] shadow-ethereal shrink-0">
        ...
        {info.action && (
          <button
            ...
            className="btn-pill-primary h-10 px-6 text-[13px] flex items-center justify-center shrink-0"
          >
